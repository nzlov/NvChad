...
wk.register {
  ["<leader>"] = {
    ...
    c = {
      ...
      g = { "<cmd>ChatGPTRun grammar_correction lang=中文 <CR>", "Grammar Correction", mode = { "n", "v" } },
      t = { "<cmd>ChatGPTRun translate lang=中文 <CR>", "Translate", mode = { "n", "v" } },
      k = { "<cmd>ChatGPTRun keywords lang=中文 <CR>", "Keywords", mode = { "n", "v" } },
      d = { "<cmd>ChatGPTRun docstring lang=中文 <CR>", "Docstring", mode = { "n", "v" } },
      a = { "<cmd>ChatGPTRun add_tests lang=中文 <CR>", "Add Tests", mode = { "n", "v" } },
      o = { "<cmd>ChatGPTRun optimize_code lang=中文 <CR>", "Optimize Code", mode = { "n", "v" } },
      s = { "<cmd>ChatGPTRun summarize lang=中文 <CR>", "Summarize", mode = { "n", "v" } },
      f = { "<cmd>ChatGPTRun fix_bugs lang=中文 <CR>", "Fix Bugs", mode = { "n", "v" } },
      x = { "<cmd>ChatGPTRun explain_code lang=中文 <CR>", "Explain Code", mode = { "n", "v" } },
      r = { "<cmd>ChatGPTRun roxygen_edit lang=中文 <CR>", "Roxygen Edit", mode = { "n", "v" } },
      l = {
